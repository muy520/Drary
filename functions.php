...
$link = '<a class="Next frame" href="' . $content['permalink'] . '" title="' . $content['title'] . '"><div>下一篇</div></a>';
echo $link;
} else {
echo $default;
}
...
if ($content) {
$content = $widget->filter($content);
$link = '<a class="Prev frame" href="' . $content['permalink'] . '" title="' . $content['title'] . '"><div>上一篇</div></a>';
echo $link;
} else {
echo $default;
}
